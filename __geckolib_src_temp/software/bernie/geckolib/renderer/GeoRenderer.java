...
public interface GeoRenderer<T extends GeoAnimatable> {
	 ...
	 */
	default Identifier getTextureLocation(T animatable) {
	 ...
	 */
	@Nullable
	default RenderLayer getRenderType(T animatable, Identifier texture,
	 ...
	 */
	default void defaultRender(MatrixStack poseStack, T animatable, VertexConsumerProvider bufferSource, @Nullable RenderLayer renderType, @Nullable VertexConsumer buffer,
	 ...
	 * <p>
	 * Usually you'd use this for rendering alternate {@link RenderLayer} layers or for sub-model rendering whilst inside a {@link GeoRenderLayer} or similar
	 */
	default void reRender(BakedGeoModel model, MatrixStack poseStack, VertexConsumerProvider bufferSource, T animatable,
						  RenderLayer renderType, VertexConsumer buffer, float partialTick,
	 ...
	 */
	default void actuallyRender(MatrixStack poseStack, T animatable, BakedGeoModel model, @Nullable RenderLayer renderType,
	 ...
	 */
	default void preApplyRenderLayers(MatrixStack poseStack, T animatable, BakedGeoModel model, @Nullable RenderLayer renderType, VertexConsumerProvider bufferSource,
	 ...
	 */
	default void applyRenderLayersForBone(MatrixStack poseStack, T animatable, GeoBone bone, RenderLayer renderType, VertexConsumerProvider bufferSource,
	 ...
	 */
	default void applyRenderLayers(MatrixStack poseStack, T animatable, BakedGeoModel model, @Nullable RenderLayer renderType, VertexConsumerProvider bufferSource,
								   @Nullable VertexConsumer buffer, float partialTick, int packedLight, int packedOverlay) {
		for (GeoRenderLayer<T> renderLayer : getRenderLayers()) {
	 ...
	 */
	default void preRender(MatrixStack poseStack, T animatable, BakedGeoModel model, @Nullable VertexConsumerProvider bufferSource, @Nullable VertexConsumer buffer, boolean isReRender, float partialTick, int packedLight,
	 ...
	 */
	default void postRender(MatrixStack poseStack, T animatable, BakedGeoModel model, VertexConsumerProvider bufferSource, @Nullable VertexConsumer buffer, boolean isReRender, float partialTick, int packedLight, int packedOverlay, int colour) {}
	 ...
	 */
	default void renderFinal(MatrixStack poseStack, T animatable, BakedGeoModel model, VertexConsumerProvider bufferSource, @Nullable VertexConsumer buffer, float partialTick, int packedLight,
							 int packedOverlay, int colour) {}
	 ...
	 */
	default void renderRecursively(MatrixStack poseStack, T animatable, GeoBone bone, RenderLayer renderType, VertexConsumerProvider bufferSource,
	 ...
	 */
	default void renderCubesOfBone(MatrixStack poseStack, GeoBone bone, VertexConsumer buffer, int packedLight,
								   int packedOverlay, int colour) {
		if (bone.isHidden())
			return;
	 ...
	 */
	default void renderChildBones(MatrixStack poseStack, T animatable, GeoBone bone, RenderLayer renderType, VertexConsumerProvider bufferSource, VertexConsumer buffer,
	 ...
	 */
	default void renderCube(MatrixStack poseStack, GeoCube cube, VertexConsumer buffer, int packedLight,
							int packedOverlay, int colour) {
	...
	default void createVerticesOfQuad(GeoQuad quad, Matrix4f poseState, Vector3f normal, VertexConsumer buffer,
		...
		for (GeoVertex vertex : quad.vertices()) {
			...
			buffer.vertex(vector4f.x(), vector4f.y(), vector4f.z(), colour, vertex.texU(),
	 ...
	 */
	boolean firePreRenderEvent(MatrixStack poseStack, BakedGeoModel model, VertexConsumerProvider bufferSource, float partialTick, int packedLight);

	/**
	 * Create and fire the relevant {@code Post-Render} event hook for this renderer
	 */
	void firePostRenderEvent(MatrixStack poseStack, BakedGeoModel model, VertexConsumerProvider bufferSource, float partialTick, int packedLight);
	...
	@ApiStatus.Internal
	default VertexConsumer checkAndRefreshBuffer(boolean isReRender, VertexConsumer buffer, VertexConsumerProvider bufferSource, RenderLayer renderType) {
		if (isReRender)
			return buffer;
