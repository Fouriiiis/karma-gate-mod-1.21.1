package dev.fouriis.karmagate.client.graffiti.old;
 ...
 */
public class GraffitiPickerScreenOld extends Screen {
    ...
    public GraffitiPickerScreenOld(double x, double y, double z, Direction facing) {
        this(x, y, z, facing, null);
    }

    public GraffitiPickerScreenOld(java.util.function.Consumer<String> onTextureSelected) {
        this(0.0, 0.0, 0.0, Direction.NORTH, onTextureSelected);
    }

    private GraffitiPickerScreenOld(double x, double y, double z, Direction facing,
