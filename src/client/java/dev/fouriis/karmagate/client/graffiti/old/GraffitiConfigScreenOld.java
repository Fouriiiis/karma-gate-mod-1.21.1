...
import dev.fouriis.karmagate.client.graffiti.GraffitiPickerScreen;
...
@Deprecated
public class GraffitiConfigScreenOld extends Screen {
    ...
    public GraffitiConfigScreenOld(GraffitiEntity graffiti) {
    ...
    protected void init() {
        ...
        form.addRow(new LabeledButtonWidget(0, 0, formWidth, 20,
                ...
                btn -> MinecraftClient.getInstance().setScreen(new GraffitiPickerScreen(tex -> {
                    applyTexture(tex);
                    MinecraftClient.getInstance().setScreen(new GraffitiConfigScreenOld(graffiti));
                })),
                List.of(), null));
