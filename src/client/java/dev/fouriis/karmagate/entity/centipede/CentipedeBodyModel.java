 ...
 * Uses the centipede_body.geo.json model and centipede.png texture.
 */
public class CentipedeBodyModel extends GeoModel<CentipedeBodyEntity> {

    private static final Identifier MODEL = Identifier.of(KarmaGateMod.MOD_ID, "geo/centipede_body.geo.json");
